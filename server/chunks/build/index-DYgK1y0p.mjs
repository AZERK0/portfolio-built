...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-384fcda9><div class="hero" data-v-384fcda9></div>`);
      _push(ssrRenderComponent(_component_ULandingHero, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative flex justify-end" data-v-384fcda9${_scopeId}><div class="portrait-background absolute w-4/5 h-full rounded-full mix-blend-difference bg-" data-v-384fcda9${_scopeId}></div>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(unref(page).testimonials.items, (testimonial, index2) => {
                    _push3(`<div class="break-inside-avoid" data-v-384fcda9${_scopeId2}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-384fcda9"]]);

export { index as default };
//# sourceMappingURL=index-DYgK1y0p.mjs.map
