import { _ as _export_sfc, u as useHead, a as __nuxt_component_0$7 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-bcd609c0><div class="fixed left-0 right-0 spotlight z-10" data-v-bcd609c0></div><div class="max-w-520px text-center z-20" data-v-bcd609c0><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-bcd609c0>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-bcd609c0>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-bcd609c0>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.7.4_eslint@9.13.0_jiti@2.3.3__ioredis@5.4.1__jitvlx3a2ciaxx2zsent5j2hxm/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bcd609c0"]]);

export { error404 as default };
//# sourceMappingURL=error-404-B3DFRPhW.mjs.map
