import { m as mergeConfig, e as appConfig, b as useUI, f as useInjectButtonGroup, t as tooltip, g as usePopper, n as nuxtLinkProps, j as config$b, k as getNuxtLinkProps, l as getSlotChildrenText, r as button, i as __nuxt_component_1$1, d as __nuxt_component_0$3, s as s$5, v as omit, _ as _export_sfc, h as useAppConfig, o as __nuxt_component_0$2, a as __nuxt_component_0$7, w as useAsyncData, x as useSeoMeta, c as __nuxt_component_0$8, p as __nuxt_component_9, q as __nuxt_component_2$1 } from './server.mjs';
...
import { _ as _sfc_main$e } from './NuxtImg-rMvQWX0S.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-0ff8c3b0><div class="hero" data-v-0ff8c3b0></div>`);
      _push(ssrRenderComponent(_component_ULandingHero, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative flex justify-end" data-v-0ff8c3b0${_scopeId}><div class="portrait-background absolute w-4/5 h-full rounded-full mix-blend-difference bg-" data-v-0ff8c3b0${_scopeId}></div>`);
      ...
      _push(ssrRenderComponent(_component_ULandingSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="studies" class="flex flex-col sm:flex-row gap-8 scroll-mt-[calc(var(--header-height)+140px+128px+96px)]" data-v-0ff8c3b0${_scopeId}><!--[-->`);
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_ULandingCard, mergeProps({ ref_for: true }, item, {
                      ...
                      description: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span data-v-0ff8c3b0${_scopeId3}>${item.description ?? ""}</span>`);
                        } else {
                          return [
                            createVNode("span", {
      ...
      _push(ssrRenderComponent(_component_ULandingSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="pricing" class="flex justify-center scroll-mt-[calc(var(--header-height)+140px+128px+96px)]" data-v-0ff8c3b0${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(unref(page).testimonials.items, (testimonial, index2) => {
                    _push3(`<div class="break-inside-avoid" data-v-0ff8c3b0${_scopeId2}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0ff8c3b0"]]);

export { index as default };
//# sourceMappingURL=index-ADYo93Nq.mjs.map
