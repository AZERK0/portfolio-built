...
import { L as useState, v as useAsyncData, I as useRuntimeConfig, a as __nuxt_component_0$7 } from './server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-ByJ6oR_d.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-sDBIdIMO.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-CzQzOg2t.mjs.map
