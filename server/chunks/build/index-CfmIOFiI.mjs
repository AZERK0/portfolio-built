  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ULandingHero, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative flex justify-end"${_scopeId}><div class="absolute w-4/5 h-full rounded-full" style="${ssrRenderStyle({ "backdrop-filter": "invert(0.05) grayscale(0.5)" })}"${_scopeId}></div>`);
...
//# sourceMappingURL=index-CfmIOFiI.mjs.map
