...
import { u as useRequestEvent, a as useContentPreview } from './preview-xVq093Dj.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-sDBIdIMO.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-ByJ6oR_d.mjs.map
