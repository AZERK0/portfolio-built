...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-66a7f7da><div class="hero" data-v-66a7f7da></div>`);
      _push(ssrRenderComponent(_component_ULandingHero, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative flex justify-end" data-v-66a7f7da${_scopeId}><div class="portrait-background absolute w-4/5 h-full rounded-full mix-blend-difference bg-" data-v-66a7f7da${_scopeId}></div>`);
      ...
      _push(ssrRenderComponent(_component_ULandingSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="studies" class="flex flex-col sm:flex-row gap-8 scroll-mt-[calc(var(--header-height)+140px+128px+38px)]" data-v-66a7f7da${_scopeId}><!--[-->`);
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_ULandingCard, mergeProps({ ref_for: true }, item, {
                      ...
                      description: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span data-v-66a7f7da${_scopeId3}>${item.description ?? ""}</span>`);
                        } else {
                          return [
                            createVNode("span", {
      ...
      _push(ssrRenderComponent(_component_ULandingSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="pricing" class="flex justify-center scroll-mt-[calc(var(--header-height)+140px+128px)]" data-v-66a7f7da${_scopeId}>`);
                ...
                if (_push3) {
                  ...
                  ssrRenderList(unref(page).projects.items, (project, index2) => {
                    _push3(ssrRenderComponent(_component_UBlogPost, mergeProps({
                      ...
                      description: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span data-v-66a7f7da${_scopeId3}>${project.description ?? ""}</span>`);
                        } else {
                          return [
                            createVNode("span", {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-66a7f7da"]]);

export { index as default };
//# sourceMappingURL=index-CeMZ-Rj2.mjs.map
