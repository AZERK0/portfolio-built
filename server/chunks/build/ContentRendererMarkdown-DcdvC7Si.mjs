...
import { B as pascalCase, l as kebabCase, o as destr } from '../runtime.mjs';
import { find, html } from 'property-information';
import { f as flatUnwrap } from './node-04k6j4dz.mjs';
import { ssrRenderComponent } from 'vue/server-renderer';
import { a as useContentPreview } from './preview-VAZHrGFZ.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxtjs+mdc@0.9.2_magicast@0.3.5_rollup@4.24.0/node_modules/@nuxtjs/mdc/dist/runtime/components/MDCRenderer.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+content@2.13.4_ioredis@5.4.1_magicast@0.3.5_nuxt@3.13.2_@parcel+watcher@2.4.1_@types+no_qa7mrztxm6vz5jlo2z6dn27ymy/node_modules/@nuxt/content/dist/runtime/components/ContentRendererMarkdown.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ContentRendererMarkdown-DcdvC7Si.mjs.map
