import { x as withLeadingSlash, r as joinURL, y as withoutTrailingSlash, C as withBase, A as hash } from '../runtime.mjs';
import { a0 as useRuntimeConfig } from './server.mjs';
import { u as useRequestEvent, a as useContentPreview } from './preview-iiocoqHO.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BheHl_KN.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-B4jychzo.mjs.map
