...
import { O as useState, y as useAsyncData, K as useRuntimeConfig, a as __nuxt_component_0$7 } from './server.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-BwYGrkb6.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CrVPwiRM.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BMZZ4a-j.mjs.map
