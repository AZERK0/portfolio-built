...
import { u as useRequestEvent, a as useContentPreview } from './preview-VAZHrGFZ.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CrVPwiRM.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-BwYGrkb6.mjs.map
