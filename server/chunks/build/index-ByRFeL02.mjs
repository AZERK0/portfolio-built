import { m as mergeConfig, e as appConfig, b as useUI, f as useInjectButtonGroup, t as tooltip, g as usePopper, n as nuxtLinkProps, j as config$b, k as getNuxtLinkProps, l as getSlotChildrenText, q as avatar, r as getSlotsChildren, s as __nuxt_component_4$1, v as button, i as __nuxt_component_1$1, d as __nuxt_component_0$3, w as s$5, x as omit, _ as _export_sfc, h as useAppConfig, o as __nuxt_component_0$2, a as __nuxt_component_0$7, y as useAsyncData, z as useSeoMeta, c as __nuxt_component_0$8, p as __nuxt_component_9 } from './server.mjs';
import { useSSRContext, defineComponent, toRef, computed, ref, useSlots, unref, mergeProps, withCtx, createVNode, openBlock, createBlock, createCommentVNode, renderSlot, createTextVNode, toDisplayString, cloneVNode, h, Fragment, renderList, watch, useId, createSlots, withAsyncContext, resolveComponent, withKeys, Transition, withDirectives, vShow } from 'vue';
...
import { _ as _sfc_main$e } from './NuxtImg-JuSw4pZI.mjs';
...
import { N, Q, V } from './disclosure-DysKdcdS.mjs';
import { q as queryContent } from './query-BwYGrkb6.mjs';
import 'node:http';
import 'node:https';
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$3]]);
...
const config$2 = mergeConfig(appConfig.ui.strategy, appConfig.ui.tooltip, tooltip);
const _sfc_main$a = defineComponent({
  ...
  setup(props) {
    const { ui, attrs } = useUI("tooltip", toRef(props, "ui"), config$2, toRef(props, "class"));
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$2]]);
...
const config$1 = mergeConfig(appConfig.ui.strategy, appConfig.ui.chip, chip);
const _sfc_main$8 = defineComponent({
  ...
  props: {
    ...
    position: {
      type: String,
      default: () => config$1.default.position,
      validator(value) {
        return Object.keys(config$1.position).includes(value);
      }
    },
    text: {
      type: [String, Number],
    ...
    inset: {
      type: Boolean,
      default: () => config$1.default.inset
    },
    show: {
      type: Boolean,
      default: true
  ...
  setup(props) {
    const { ui, attrs } = useUI("chip", toRef(props, "ui"), config$1, toRef(props, "class"));
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$1]]);
...
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-a7bb7dd3"]]);
...
const __nuxt_component_3 = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const clones = computed(() => children.value.map((node, index2) => {
      const vProps = {};
      if (!props.max || max.value && index2 < max.value) {
        if (props.size) {
      ...
      if (max.value !== void 0 && index2 === max.value) {
          ...
          if ((_a2 = __props.authors) == null ? void 0 : _a2.length) {
            _push(ssrRenderComponent(_component_UAvatarGroup, null, {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<!--[-->`);
                  ssrRenderList(__props.authors, (author, index2) => {
                  ...
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.authors, (author, index2) => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ULandingHero = _sfc_main$d;
      const _component_UBadge = __nuxt_component_1;
      const _component_UIcon = __nuxt_component_1$1;
      const _component_NuxtImg = _sfc_main$e;
      const _component_ULandingLogos = _sfc_main$b;
      const _component_UTooltip = __nuxt_component_5;
      const _component_ULandingSection = _sfc_main$9;
      ...
      const _component_UBlogList = _sfc_main$5;
      const _component_UBlogPost = _sfc_main$4;
      const _component_ULandingCTA = _sfc_main$3;
      const _component_ULandingFAQ = _sfc_main$1;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-61be4747><div class="hero" data-v-61be4747></div>`);
      _push(ssrRenderComponent(_component_ULandingHero, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative flex justify-end" data-v-61be4747${_scopeId}><div class="portrait-background absolute w-4/5 h-full rounded-full mix-blend-difference bg-" data-v-61be4747${_scopeId}></div>`);
      ...
      _push(ssrRenderComponent(_component_ULandingSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="studies" class="flex flex-col sm:flex-row gap-8 scroll-mt-[calc(var(--header-height)+140px+128px+96px)]" data-v-61be4747${_scopeId}><!--[-->`);
            ssrRenderList(unref(page).studies.items, (item, index2) => {
              _push2(`<!--[-->`);
              _push2(ssrRenderComponent(_component_UChip, {
                class: "flex-1",
                color: "green",
                position: "top-left",
                show: index2 === unref(page).studies.items.length - 1,
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_ULandingCard, mergeProps({ ref_for: true }, item, {
                      ...
                      description: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span data-v-61be4747${_scopeId3}>${item.description ?? ""}</span>`);
                        } else {
                          return [
                            createVNode("span", {
              ...
              if (index2 < unref(page).studies.items.length - 1) {
                _push2(ssrRenderComponent(_component_UDivider, {
            ...
            return [
              createVNode("div", {
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(unref(page).studies.items, (item, index2) => {
                  return openBlock(), createBlock(Fragment, { key: index2 }, [
                    ...
                    index2 < unref(page).studies.items.length - 1 ? (openBlock(), createBlock(_component_UDivider, {
                      key: 0,
                      icon: "i-heroicons-arrow-right",
                      class: "w-20"
                    })) : createCommentVNode("", true)
      ...
      _push(ssrRenderComponent(_component_ULandingSection, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div id="pricing" class="flex justify-center scroll-mt-[calc(var(--header-height)+140px+128px+96px)]" data-v-61be4747${_scopeId}>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UBlogList, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(unref(page).projects.items, (project, index2) => {
                    _push3(ssrRenderComponent(_component_UBlogPost, mergeProps({
                      ...
                      description: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span data-v-61be4747${_scopeId3}>${project.description ?? ""}</span>`);
                        } else {
                          return [
                            createVNode("span", {
                  ...
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(page).projects.items, (project, index2) => {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-61be4747"]]);

export { index as default };
//# sourceMappingURL=index-ByRFeL02.mjs.map
